...
##
## Purpose of script:
##    Create figure s2, proportion of people of various racial/ethnic groups in DACs by metric
##
...
figure_s2 <- ggplot(ex, aes(fill=variable, y=value, x=dac)) + 
...
# Export ---------------------------
cowplot::ggsave2("outputs/figures/fig_s2.png", figure_s2,
                 width = 7,
                 height = 4,
                 units = c("in"))  
