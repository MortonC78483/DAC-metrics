...
##
## Purpose of script:
##    Create figure for ANOVA results with significance indicators for five metrics
##
...
cowplot::ggsave2("outputs/figures/fig_s01.png", figure_3,
                 width = 8,
                 height = 6,
                 units = c("in"))
