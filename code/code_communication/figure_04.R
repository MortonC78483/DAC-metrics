...
##
## Purpose of script:
##    Create figure 4, likelihood of living in a DAC based on population 
...
figure_4_parts <- cowplot::plot_grid(part_a + theme(legend.position="none"), 
...
# add common legend
figure_4 <- cowplot::plot_grid(figure_4_parts, legend, nrow = 2, rel_heights = c(1, .1))
