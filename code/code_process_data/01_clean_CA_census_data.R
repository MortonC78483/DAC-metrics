...
##    and tract-level data on poverty, race/ethnicity, and linguistic 
##    isolation for California. Creates tract level univariate DAC designation
...
# join shapefile to tract dataset
tract <- merge(tract, tract_sf) %>%
...
write_csv(tract, "data/data_interim/CA_census_tract.csv")
